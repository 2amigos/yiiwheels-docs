...
<?php $this->widget(
    ...
    array(
        'brandLabel' => img('images/logo-navbar.png'),
...
<footer class="footer">
    <div class="container">
        <div class="text-center">
            <p class="credits">
                Developed by <a href="http://www.ramirezcobos.com/" target="_blank">Antonio Ramirez</a> and <a
                    href="http://www.2amigos.us" target="_blank">Matt Tabin</a>. Design by <a
                    href="https://twitter.com/adnanblog" target="_blank">Adnan</a>.
            </p>

            <p class="license">
                Code licensed under <a href="http://opensource.org/licenses/BSD-3-Clause">BSD-3-Clause License</a>,
