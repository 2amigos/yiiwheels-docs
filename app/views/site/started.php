        ...
        <div class="row">
            <div class="span6">
                ...
                <p><a class="btn btn-large btn-primary"
                      href="https://github.com/2amigos/yiiwheels/archive/2.0.3.zip">Download Yiiwheels 2.0.3</a></p>
                <p>Looking for older version for Bootstrap 2+? </p>
                <p><a class="btn btn-large btn-default"
                      href="https://github.com/2amigos/yiiwheels/archive/1.0.6.zip">Download Yiiwheels 1.0.6</a></p>
            </div>
            <div class="span6">
                <h2>Clone</h2>
