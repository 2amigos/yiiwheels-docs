...
<div class="jumbotron masthead">
    <div class="container">
        ...
        <p><a href="https://github.com/2amigos/yiiwheels/archive/1.0.3.zip" class="btn btn-inverse btn-large"
              onclick="_gaq.push(['_trackEvent', 'Jumbotron actions', 'Download', 'Download 1.0.3']);">Download
                Yiiwheels</a></p>
