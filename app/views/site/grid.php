...
$this->widget('yiiwheels.widgets.grid.WhGridView', array(
    ...
    <section id="groupgridview">
        <h2>Group Grid View
            <small>WhGroupGridView.php</small>
        </h2>
        ...
        <div class="bs-docs-example">
            <?php
            $this->widget(
                'yiiwheels.widgets.grid.WhGroupGridView',
                array(
                    'type' => 'striped bordered',
                    'dataProvider' => Person::getGridDataProvider(),
                    'template' => "{items}",
...
?&gt;
    ...
    <section id="imagecolumn">
        ...
        <p>
            Display an image on your grid. In order to display an image related to the data provider of the grid, you
            set
...
$this->widget('yiiwheels.widgets.grid.WhGridView', array(
    ...
    <section id="relationalcolumn">
        ...
        <p>
            <span class="label label-important">Important</span>: Do not use this type of column to display a link. It
            is
...
$this-&gt;widget('yiiwheels.widgets.grid.WhGridView', array(
    ...
    <section id="toggle">
        ...
        <p>
            Allows to modify the value of column on the fly. This type of column is good when you wish to modify the
            value of
            a displayed model that has two states: yes-no, true-false, 1-0, etc...
        </p>

        <p>
            The widget works in conjunction with an action that will receive the <code>id</code> and the
            <code>attribute</code>
            parameters. <code>YiiWheels</code> comes with an action ready to use for that purpose:
            <code>WhToggleAction</code>
